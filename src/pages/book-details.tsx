      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-4">
          <div className="aspect-[3/4] overflow-hidden rounded-lg">
            <img
              src={bookData.images[selectedImage] || "/placeholder.svg"}
              alt={bookData.title}
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="flex items-center gap-4 mb-6">
              <span className="text-3xl font-bold">${bookData.price}</span>
              {bookData.originalPrice > bookData.price && (
                <span className="text-xl text-muted-foreground line-through">${bookData.originalPrice}</span>
              )}
              {bookData.originalPrice > bookData.price && (
                <Badge variant="destructive">Save ${(bookData.originalPrice - bookData.price).toFixed(2)}</Badge>
              )}
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              >
                {[...Array(Math.min(10, bookData.stockCount))].map((_, i) => (
                  <option key={i + 1} value={i + 1}>
                    {i + 1}
                  </option>
                ))}
              </select>
              <span className="text-sm text-muted-foreground">{bookData.stockCount} in stock</span>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>Year: {bookData.publishYear}</div>
              <div className="col-span-2">ISBN: {bookData.isbn}</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <TabsContent value="description" className="mt-6">
            <Card>
              <CardContent className="p-6">
                <p className="text-lg leading-relaxed">{bookData.description}</p>
                <div className="mt-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span>{bookData.publishYear}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Language:</span>

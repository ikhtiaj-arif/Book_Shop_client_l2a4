    ...
    return (
        <div className={`flex items-center text-center mt-1 ${className}`}>
            ...
            <button
                onClick={onDecrease}
                disabled={quantity <= 1}
                className="relative w-8 h-8 flex items-center justify-center text-text text-lg font-medium rounded-l-full border bg-primary disabled:opacity-50"
            >
            ...
            <button
                ...
                className="w-8 h-8 relative flex items-center justify-center text-text text-lg font-medium rounded-r-full border bg-primary  disabled:opacity-50"
            >
                <span className="absolute right-[6px] top-[-1px]">+</span>
            </button>
        </div>
